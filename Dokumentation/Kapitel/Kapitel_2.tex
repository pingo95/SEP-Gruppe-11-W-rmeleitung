...
\begin{enumerate}
	...
	\item Der Benutzer kann um das Problem zu spezifizieren Funktionen für die Anfangs- und Randbedingungen vorgeben.
...
\begin{enumerate}
	...
	\item Fehlerbehandlung/Robustheit
	\item Grafische Oberfläche skaliert korrekt bei Veränderung der Fenstergröße
	\item Die Berechnung im Laufe der Simulation soll innerhalb von maximal 15 Sekunden abgeschlossen sein.
\end{enumerate}
